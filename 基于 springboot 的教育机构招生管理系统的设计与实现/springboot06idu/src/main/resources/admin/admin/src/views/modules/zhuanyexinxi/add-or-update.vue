<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="招生单位" prop="xuexiaomingcheng">
          <el-input v-model="ruleForm.xuexiaomingcheng" 
              placeholder="招生单位" clearable  :readonly="ro.xuexiaomingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="招生单位" prop="xuexiaomingcheng">
              <el-input v-model="ruleForm.xuexiaomingcheng" 
                placeholder="招生单位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="专业类别" prop="zhuanyeleibie">
          <el-input v-model="ruleForm.zhuanyeleibie" 
              placeholder="专业类别" clearable  :readonly="ro.zhuanyeleibie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="专业类别" prop="zhuanyeleibie">
              <el-input v-model="ruleForm.zhuanyeleibie" 
                placeholder="专业类别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="招录人数" prop="zhaolurenshu">
          <el-input v-model="ruleForm.zhaolurenshu" 
              placeholder="招录人数" clearable  :readonly="ro.zhaolurenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="招录人数" prop="zhaolurenshu">
              <el-input v-model="ruleForm.zhaolurenshu" 
                placeholder="招录人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="招录状态" prop="zhaoluzhuangtai">
          <el-select :disabled="ro.zhaoluzhuangtai" v-model="ruleForm.zhaoluzhuangtai" placeholder="请选择招录状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="招录状态" prop="zhaoluzhuangtai">
	      <el-input v-model="ruleForm.zhaoluzhuangtai"
                placeholder="招录状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="招录要求" prop="zhaoluyaoqiu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="招录要求"
                  v-model="ruleForm.zhaoluyaoqiu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhaoluyaoqiu" label="招录要求" prop="zhaoluyaoqiu">
                    <span>{{ruleForm.zhaoluyaoqiu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
	...
	zhaoluzhuangtai : false,
      ...
      ruleForm: {
       ...
       zhaoluzhuangtai: '未满',
          ...
          zhaoluzhuangtaiOptions: [],
      rules: {
          xuexiaomingcheng: [
                { required: true, message: '招生单位不能为空', trigger: 'blur' },
          ],
          zhuanyemingcheng: [
          ...
          zhaolurenshu: [
                { required: true, message: '招录人数不能为空', trigger: 'blur' },
          ],
          zhaoluyaoqiu: [
          ],
          zhaoluzhuangtai: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhuanyemingcheng = true;
          ...
          if(o=='zhuanyeleibie'){
            this.ruleForm.zhuanyeleibie = obj[o];
	    this.ro.zhuanyeleibie = true;
            continue;
          }
          if(o=='tupian'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='zhaolurenshu'){
            this.ruleForm.zhaolurenshu = obj[o];
	    this.ro.zhaolurenshu = true;
            continue;
          }
          if(o=='zhaoluyaoqiu'){
            this.ruleForm.zhaoluyaoqiu = obj[o];
	    this.ro.zhaoluyaoqiu = true;
            continue;
          }
          if(o=='zhaoluzhuangtai'){
            this.ruleForm.zhaoluzhuangtai = obj[o];
	    this.ro.zhaoluzhuangtai = true;
            continue;
          }
        }
      }
