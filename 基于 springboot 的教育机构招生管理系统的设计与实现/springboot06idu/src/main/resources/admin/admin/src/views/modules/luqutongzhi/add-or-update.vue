<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="通知时间" prop="tongzhishijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tongzhishijian" label="通知时间" prop="tongzhishijian">
              <el-input v-model="ruleForm.tongzhishijian" 
                placeholder="通知时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="录取结果" prop="luqujieguo">
          <el-select :disabled="ro.luqujieguo" v-model="ruleForm.luqujieguo" placeholder="请选择录取结果">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="录取结果" prop="luqujieguo">
	      <el-input v-model="ruleForm.luqujieguo"
                placeholder="录取结果" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  data() {
	...
	tongzhineirong : false,
      ...
      rules: {
          ...
          luqujieguo: [
                { required: true, message: '录取结果不能为空', trigger: 'blur' },
          ],
          tongzhineirong: [
          ],
      }
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tongzhishijian = true;
          ...
          if(o=='luqujieguo'){
            this.ruleForm.luqujieguo = obj[o];
	    this.ro.luqujieguo = true;
            continue;
          }
          if(o=='tongzhineirong'){
